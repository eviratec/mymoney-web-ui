...
angular.module('MyMoneyWebui', ['ngAnimate', 'ngAria', 'ngCookies', 'ngMaterial', 'ngMessages', 'ui.router', 'luminous.environment', 'MyMoneyWebui.Api', 'MyMoneyWebui.Anon', 'MyMoneyWebui.User', 'MyMoneyWebui.CategoryPage', 'MyMoneyWebui.ListPage']);
'use strict';
...
function appEnvironment($appEnvironmentProvider) {
  ...
  $appEnvironmentProvider.setDefaults({
    ...
    titlePrefix: 'LOCAL :: ',
    apiUrl: 'http://localhost:3580'
  }).addEnvironment('prod', 'my.mymoney.com', {
    titlePrefix: '',
    apiUrl: 'https://api.mymoney.com'
  }).addEnvironment('prod2', 'https://my.mymoney.com', {
    titlePrefix: '',
    apiUrl: 'https://api.mymoney.com'
...
function appInit($appEnvironment, $document) {
  ...
  $document[0].title = $appEnvironment.config.titlePrefix + 'MyMoney Web UI';
...
angular.module('MyMoneyWebui.CategoryPage', ['ngAnimate', 'ngAria', 'ngCookies', 'ngMaterial', 'ngMessages', 'ui.router', 'luminous.environment']);
'use strict';
...
angular.module('MyMoneyWebui.ListPage', ['ngAnimate', 'ngAria', 'ngCookies', 'ngMaterial', 'ngMessages', 'ui.router', 'luminous.environment']);
'use strict';
...
angular.module('MyMoneyWebui.CategoryPage').config(['$stateProvider', function ($stateProvider) {
...
angular.module('MyMoneyWebui.ListPage').config(['$stateProvider', function ($stateProvider) {
...
angular.module('MyMoneyWebui.CategoryPage').controller('CategoryPageController', CategoryPageController);
...
angular.module('MyMoneyWebui.ListPage').controller('ListPageController', ListPageController);
